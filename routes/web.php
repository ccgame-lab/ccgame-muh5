...
Route::get('/api/sdk/bootstrap', function (Request $request) {
    ...
    return response()->json([
        ...
        'tabs' => [
            ...
            ['key' => 'topup',         'label' => 'Nạp Tôm',    'icon' => 'payments'],
            ['key' => 'shop',          'label' => 'Cửa hàng',   'icon' => 'storefront'],
            ['key' => 'spin',          'label' => 'Vòng quay',  'icon' => 'cyclone'],
            ['key' => 'mining',        'label' => 'Đào KC',     'icon' => 'construction'],
            ['key' => 'giftcode',      'label' => 'Giftcode',   'icon' => 'redeem'],
            ['key' => 'transactions',  'label' => 'Giao dịch',  'icon' => 'receipt_long'],
            ['key' => 'ranking',       'label' => 'BXH',        'icon' => 'leaderboard'],
