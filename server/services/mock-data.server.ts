...
export const getTransactionHistory = (): Transaction[] => {
  return [
    { id: 'tx_1', amount: 10000, type: 'deposit', description: 'Nạp thẻ cào', createdAt: '2026-05-20T10:00:00Z' },
    { id: 'tx_2', amount: 5000, type: 'spend', description: 'Mua gói khởi đầu', createdAt: '2026-05-21T14:30:00Z' },
    { id: 'tx_3', amount: 200, type: 'withdraw', description: 'Rút quà event', createdAt: '2026-05-25T09:15:00Z' },
  ]
}

export const getShopItems = (): ShopItem[] => {
  return [
    { id: 'item_1', name: 'Gói Tân Thủ', description: 'Nhận ngay vũ khí siêu cấp', price: 10000, currency: 'coin' },
    { id: 'item_2', name: 'Vé Quay May Mắn', description: 'Dùng cho Vòng Quay', price: 50, currency: 'diamond' },
    { id: 'item_3', name: 'Thẻ Đổi Tên', description: 'Đổi tên nhân vật', price: 200, currency: 'diamond' },
  ]
}
